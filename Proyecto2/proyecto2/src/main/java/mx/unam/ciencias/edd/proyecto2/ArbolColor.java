...
import java.util.NoSuchElementException;
  ...
  public class ArbolColor extends ArbolRojinegro<Integer> implements AccionVerticeArbolBinario<Integer>{
    ...
    *
    **/
    ArbolColor(Lista<Integer> enteros){
      this.enteros=enteros;
      arbol=new ArbolRojinegro<>(enteros);
    }
    ...
    **/
    ...
    private void setTamanoCanvas(){
      ancho=(100+(enteros.getElementos()*(getGrande()+ 170)));
      alto=100+(enteros.getElementos()*(getGrande()+ 20));
    }
